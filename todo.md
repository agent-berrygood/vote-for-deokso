...
- [ ] Task 9: `VoterManager.tsx`에 `participated` 데이터를 차수별로 분석하는 로직 추가
- [ ] Task 10: 테이블 헤더에 '차수별 참여' 컬럼 또는 버튼 추가 및 상세 참여 현황 다이얼로그 구현
- [ ] Task 11: 엑셀 다운로드 시 차수별 참여 여부를 열로 분리하여 출력하도록 수정
- [ ] Task 12: 수정 후 빌드/린트 검사 및 최종 Git 푸시
